					...
					@foreach($cart->produks as $cart_produk)
						<tr>
							...
							<td class="cart_description">
								<h4><a href="{{ url( $cart_produk->slug ) }}">Colorblock Scuba</a></h4>
								<!-- <p>Web ID: 1089772</p> -->
							</td>
							<td class="cart_price">
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									...
									<input class="cart_quantity_input" type="text" name="quantity" value="{{ $cart_produk->pivot->quantity }}" autocomplete="off" size="2">
